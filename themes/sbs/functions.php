...
add_filter('wp_nav_menu','change_submenu_class');  
 ...
 function sliders_function($type='sliders_function') {
...
function clients_init() {
    add_shortcode('client-lists', 'clients_function');
    $args = array('public' => true, 'label' => 'Clients', 'supports' => array('thumbnail', 'title', 'editor' ));
    register_post_type('client', $args);
}

function slider_init() {
    add_shortcode('sliders', 'sliders_function');
    $args = array('public' => true, 'label' => 'Sliders', 'supports' => array('thumbnail', 'title', 'editor' ));
